...
@Service("ProClassTableQueryServiceImpl")
public class ProClassTableQueryServiceImpl implements ClassTableQueryService{
    ...
    public String getProfessorClassTable(long id, String learnYear, int learnTerm) {
        ...
        List<CourseInfo> courseInfos=courseMapper.getProfessorClassTable(id,learnTerm,learnYear);
